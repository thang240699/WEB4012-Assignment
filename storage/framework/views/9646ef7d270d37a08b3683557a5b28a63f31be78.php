...
<head>
    ...
    <!-- CSS Files -->
    <link href="<?php echo e(asset('/public/admin/css/material-dashboard.min.css?v=2.0.2')); ?>" rel="stylesheet"/>

    <script src="<?php echo e(asset('/public/admin/js/core/jquery.min.js?v=3.2.1')); ?>"></script>
    <script>
        $(function () {
...
<div class="wrapper">
    <div class="sidebar" data-color="green" data-background-color="white"
         data-image="<?php echo e(asset('/public/admin/images/sidebar-1.jpg')); ?>">
        <div class="sidebar-wrapper">
            <div class="user">
                <div class="photo">
                    <img id="pp" src="<?php echo e(asset('public/images/user.png')); ?>" alt=""/>
                </div>
                <div class="user-info">
                    <a class="username">
            ...
            <?php echo $__env->make('admin.layouts.menu_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute fixed-top">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="<?php echo e(url('/')); ?>">Go Market</a>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Thangvvpd02424_WEB4012_Assignment\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>
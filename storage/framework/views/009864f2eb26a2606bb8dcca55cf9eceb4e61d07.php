                ...
                <div class="card card-profile">
                    <div class="card-avatar">
                        <a href="" target="_blank">
                            <img class="img" src="<?php echo e(asset('public/images/user.png')); ?>" alt="Team FIT" />
                        </a>
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Thangvvpd02424_WEB4012_Assignment\resources\views/admin/index.blade.php ENDPATH**/ ?>
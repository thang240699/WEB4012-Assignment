<ul class="nav">
    ...
    <li class="nav-item ">
        ...
        <div class="collapse" id="users">
            <ul class="nav">
                <li class="nav-item ">
                    <a class="nav-link" href="{{ URL::route('users.view') }}">
    ...
    <li class="nav-item ">
        ...
        <div class="collapse" id="categories">
            <ul class="nav">
                <li class="nav-item ">
                    <a class="nav-link" href="{{ URL::route('categories.view') }}">
                        <span class="sidebar-mini">
                            <i class="material-icons">receipt</i>
                        </span>
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="{{ URL::route('sub-categories.view') }}">
                        <span class="sidebar-mini">
                            <i class="material-icons">receipt</i>
                        </span>
    ...
    <li class="nav-item ">
        <a class="nav-link" href="{{ URL::route('products.view') }}">
            <i class="material-icons">shopping_basket</i>
            <p> Sản phẩm </p>
        </a>
    </li>
    <li class="nav-item ">
        <a class="nav-link" href="{{ URL::route('ratings.view') }}">
            <i class="material-icons">comment</i>
            <p> Đánh giá </p>
        </a>
    </li>
    <li class="nav-item ">
        <a class="nav-link" href="{{ URL::route('orders.view') }}">
